...
>
> **核心设计原则：开发者和 AI 友好，游戏研发聚焦**
> 开发者和 AI Agent 是平等的一等公民。平台聚焦游戏研发场景，提供 6 大垂直分类，Web UI 和 API 体验对等。
...
### 1.1 项目名称
GameAgentHub — 专为 Agent 和游戏研发设计的开源技能平台
...
| **双轨友好** | 开发者通过 Web UI、AI Agent 通过 API 均可完成全套操作，体验对等 |
...
**文档负责人**：产品经理
**技术审核**：开发组
**版本历史**：v1.0（2026-03-04）→ v2.0（2026-03-04，开发者+AI 双轨友好，游戏研发分类）
